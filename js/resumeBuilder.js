...
bio.display=function(){
      ...
      $("#topContacts").append(display_mobile);
      $("#topContacts").append(display_email);
      $("#topContacts").append(display_github);
      $("#topContacts").append(display_twitter);
      $("#topContacts").append(display_location);
      $("#footerContacts").append(display_mobile);
      $("#footerContacts").append(display_email);
      $("#footerContacts").append(display_github);
      $("#footerContacts").append(display_twitter);
      $("#footerContacts").append(display_location);
